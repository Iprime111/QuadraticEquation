...
files = Solver.cpp IOFunctions.cpp main.cpp Tester.cpp Logger.cpp ColorConsole.cpp SolverAssert.cpp
headers = SolverUtils.h Solver.h IOFunctions.h Tester.h ColorConsole.h Logger.h SolverAssert.h
objects = $(files:.cpp=.o)
